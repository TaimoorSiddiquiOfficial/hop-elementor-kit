...
class Hop_Ekit_Widget_Post_Title extends Widget_Base {
	...
	public function get_name() {
		return 'hop-ekits-post-title';
	}

	public function get_title() {
		return esc_html__( 'Post Title', 'hop-elementor-kit' );
	}

	public function get_icon() {
		return 'hop-eicon eicon-post-title';
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'default'   => '',
				'selectors' => array(
					'{{WRAPPER}} .hop-ekit-single-post__title' => 'text-align: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .hop-ekit-single-post__title__content' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'typography',
				'selector' => '{{WRAPPER}} .hop-ekit-single-post__title__content',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .hop-ekit-single-post__title__content' => 'mix-blend-mode: {{VALUE}}',
				),
				'separator' => 'none',
			)
		);
	...
	public function render() {
		...
		<div class="hop-ekit-single-post__title">
		<<?php
		Utils::print_validated_html_tag( $settings['tag_name'] ); ?> class="hop-ekit-single-post__title__content">
		<?php
		the_title(); ?>
		</<?php
