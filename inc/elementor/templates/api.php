...
class Api extends Source_Base {
	...
	const LIBRARY_OPTION_KEY = 'hop_library_info';

	const LIBRARY_TIMESTAMP_CACHE_KEY = 'hop_remote_update_timestamp';

	const API_INFO_URL = 'https://updates.hopframework.com/hop/';
	...
	public function get_title() {
		return esc_html__( 'Hop Library', 'hop-elementor-kit' );
	}
	...
	public function get_data( array $args, $context = 'display' ) {
		...
		if ( empty( $data ) || empty( $data['content'] ) ) {
			throw new \Exception( __( 'Template does not have any content', 'hop-elementor-kit' ) );
		}
